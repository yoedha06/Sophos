...
<div class="content bg-white">
                ...
                <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                    <li>
                        <h5 class="text text-gray-300">
                            ...
                            <span class="text-blue-500"> Computers </span> /
                            <span class="text-gray-400">{{ $computer->hostname }}</span>
                        </h5>
                    </li>
                </ul>
            </div>
    ...
    <div class="flex">
        <aside class="w-1/6 bg-white dark:bg-gray-800 p-4 text-center border-r">
            <h4 class="text-5xl mb-10 pt-14"><i class="fa-solid fa-display fa-2xl"></i></h4>
            ...
            <button
                class="mx-auto w-full p-1 mb-5 text-xs font-semibold text-gray-400 bg-gray-100 rounded cursor-not-allowed"
                disabled>Live Response</button>
            <button class="mx-auto w-full p-1 text-xs font-semibold text-blue-800 bg-gray-100 rounded">More
                actions</button>
        </aside>
