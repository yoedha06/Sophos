        ...
        <nav class="bg-gray-50 dark:bg-gray-700">
            <div class="max-w-screen-xl px-4 py-3 mx-auto">
                <div class="flex flex-col"> <!-- Changed from flex-row to flex-col -->
                    ...
                    <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                        <li>
                            <h5 class="text text-gray-300"><span class="text-blue-600">Overview </span> / <span
                                    class="text-blue-600">Endpoint Protection Dashboard</span> / <span
                                    class="text-gray-300">Computers</span></h5>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex flex-col">
                <div>
                    <div class="flex mb-4 border-gray-300">
                        ...
                        <button type="button" wire:click="fetch" class="flex items ml-2 mx-auto  text-white text-sm px-5 py-2.5 text-center me-2 bg-blue-800 rounded" wire:loading.remove>Syncronize</button>
