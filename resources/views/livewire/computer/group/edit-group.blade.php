            ...
            <div class="max-w-screen-xl px-4 py-3">
                <div class="flex flex-col">
                    <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                        <li>
                            <h1 class="text-3xl font-semibold">Endpoint Protection - Edit Computer Group</h1>
                        </li>
                    </ul>
                    <ul class="flex flex-row font-medium mt-0 space-x-8 rtl:space-x-reverse text-sm">
                        <li>
                            <h5 class="text text-gray-300">
                                ...
                                <span class="text-gray-400">Edit Computer Group</span>
                            </h5>
                        </li>
                    </ul>
                </div>
        ...
        <form wire:submit.prevent='update'>
            <div class="grid grid-cols-1 mx-5 py-4 gap-2 lg:grid-cols-2 lg:gap-2">
                <div class="h-auto px-5 py-2 rounded-lg bg-gray-50">
                    ...
                    <button type="submit"
                        class="w-full mt-12 bg-gradient-to-r from-black to-violet-800 hover:from-black hover:to-violet-600 text-white font-bold py-2 px-4 rounded">Submit</button>
                </div>
                            ...
                            <tr>
                                <th width="20%">
                                    <div class="relative inline-block group">
                                        ...
                                        <div class="absolute left-full top-1/2 transform -translate-y-1/2 ml-2 w-48 bg-white text-black text-xs rounded-lg shadow-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
