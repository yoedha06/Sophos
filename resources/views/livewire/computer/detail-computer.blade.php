    ...
    <div class="max-w-screen-xl mx-auto pt-2 pl-2 border-b">
        <div class="flex flex-col">
            <div>
                <div class="flex mb-2 border-white-300">
                    <button id="tab-summary" onclick="setActiveTab('summary')"
        ...
        <script>
            function setActiveTab(tab) {
                ...
                document.getElementById('tab-summary').className = 'flex items-center py-2 px-4 font-semibold text-sm text-gray-700 bg-gray-200 border-transparent focus:outline-none hover:border-gray-400';
                document.getElementById('tab-events').className = 'flex items-center py-2 px-4 font-semibold text-sm text-gray-700 bg-gray-200 border-transparent focus:outline-none hover:border-gray-400';
                document.getElementById('tab-status').className = 'flex items-center py-2 px-4 font-semibold text-sm text-gray-700 bg-gray-200 border-transparent focus:outline-none hover:border-gray-400';
                document.getElementById('tab-policies').className = 'flex items-center py-2 px-4 font-semibold text-sm text-gray-700 bg-gray-200 border-transparent focus:outline-none hover:border-gray-400';
        
                // Set the active tab's button
                document.getElementById(`tab-${tab}`).className = 'flex items-center py-1 px-4 m-1 font-semibold text-sm text-white bg-blue-600 border-blue-600 focus:outline-none';
            }
        </script>
