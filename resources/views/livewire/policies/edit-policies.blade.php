    ...
    <div class="content">
        ...
        <form wire:submit.prevent='update'>
            <div class="grid grid-cols-1 mx-5 py-4 gap-2 lg:grid-cols-2 lg:gap-2">
                <div class="h-80 px-5 py-2 rounded-lg bg-gray-50">
                    ...
                    @if($type != 'web-control' && $applyGroupComputers == true)
                        <div class="mb-3">
                            ...
                            <input 
                            type="text"
                            wire:model="groupComputer"
                            placeholder="Grup Computers"
                            readonly
                            class="shadow-sm bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-violet-500 focus:border-blue-500 block w-full  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
                            @error('groupComputer')
                                <div class="text-red-500">{{ $message }}</div>
                ...
                <div class="flex flex-col gap-y-4">
                                        ...
                                        <tr
                                            ...
                                            <td scope="row"
                                                ...
                                                <input type="checkbox" wire:model="selectedEndpoints"
                                                    value="{{ $computer->id_computer }}" 
                                                    @if(in_array($computer->id, $selectedEndpoints)) checked @endif
                    ...
                    @if ($applyUsers == true && $type != 'windows-firewall')
                        <div class="h-auto bg-white">
                            <div
                                class="flex justify-between w-full rounded-tr-md rounded-tl-md py-3 font-bold bg-gradient-to-r from-violet-800 to-black text-white">
                                        ...
                                        <tr
                                            ...
                                            <td scope="row"
                                                ...
                                                <input type="checkbox" wire:model="selectedUsers"
                                                    value="{{ $user->id_user }}"
                                                    @if ($user->id_user == $selectedUsers) checked @endif
                                                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                            </td>
                                            <td
                                                class="font-medium flex py-4 text-gray-900 whitespace-nowrap dark:text-white">
                    ...
                    @if($applyUsers !== true && $type != 'web-control')
                        <div class="h-32 bg-white">
                            <div class="flex justify-between w-full rounded-tr-md rounded-tl-md py-3 font-bold bg-gradient-to-r from-violet-800 to-black text-white">
                                ...
                                <span class="mx-4 text-md">{{ $countGroupComputer }}</span>
                            </div>
                            <div class="relative">
                                <label for="Search" class="sr-only">Search</label>
                                            ...
                                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                                <td scope="row"
                                                    ...
                                                    <input type="checkbox" wire:model="selectedGroupComputers"
                                                        value="{{ $gc->id_group }}"
                                                        @if (in_array($gc->id_group, $selectedGroupComputers)) checked @endif
                                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                </td>
                                                <td
                                                    class="font-medium flex py-4 text-gray-900 whitespace-nowrap dark:text-white">
